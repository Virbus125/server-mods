...
<#
    ...
    https://github.com/Griefed/ServerPackCreator/blob/6.2.0/serverpackcreator-api/src/main/resources/de/griefed/resources/server_files/default_template.ps1
...
Write-Host "Start script generated by ServerPackCreator 6.2.0."
