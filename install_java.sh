...
#   https://github.com/Griefed/ServerPackCreator/blob/6.2.0/serverpackcreator-api/src/main/resources/de/griefed/resources/server_files/default_java_template.sh
#
